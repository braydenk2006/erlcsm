...
| Feature                        | Capability Key                     | Lowest Plan | Status                | Evidence / Notes                                      |
| ------------------------------ | ---------------------------------- | ----------- | --------------------- | ----------------------------------------------------- |
| Live server status             | `server.live_status`               | Start-Up    | Verified Complete     | Live dashboard + /api/erlc/snapshot                   |
...
| Basic remote commands          | `server.remote_commands.basic`     | Start-Up    | Verified Complete     | Remote console + audit                                |
